...
export default function FriendList() {
    ...
    <h2 className="text-2xl font-black text-[#4F47EA] border-b border-zinc-800 pb-3 mb-4">
        Friend List
    </h2>
    ...
    <div className="space-y-3">
        {FriendList.map((friend) => (
            ...
            >
                ...
                <div className="h-10 w-10 rounded-full bg-[#4F47EA]/15 border border-[#4F47EA]/40 flex items-center justify-center text-[#4F47EA] font-bold">
