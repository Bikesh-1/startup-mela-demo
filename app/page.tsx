  ...
  return (
    <div className="relative min-h-screen w-full bg-white overflow-hidden">
      ...
      <div className="relative z-10 flex h-screen w-screen flex-col items-center justify-center">
        <Navbar />
        <h1 className="text-6xl font-mono font-black">The Future of Group Savings.</h1>
        ...
        <div className="flex items-center justify-center gap-4 font-mono mt-7">
          <button className=" text-white bg-[#0a0a0a] px-2 py-1 rounded cursor-pointer border border-[#0a0a0a]">Get Started</button>
          <button className="text-black px-2 py-1 rounded border border-[#0a0a0a]">Learn More</button>
        </div>
      </div>
    </div>
  );
